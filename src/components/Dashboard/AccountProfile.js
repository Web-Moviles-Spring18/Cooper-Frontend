                      ...
                      <div className="column is-6">
                        ...
                        <form role="form">
                          <div className="field">
                            ...
                            <p className="control">
                              <input name="name" placeholder="Your name ..." className="input" type="text"></input>
                            </p>
                          </div>
                          <div className="field"><label className="label bigger-font-label">Email address
                          </label>
                            <p className="control">
                              <input name="name" placeholder="Your email address ..." className="input" type="email"></input>
                            </p>
                          </div>
                          <div className="field"><label className="label bigger-font-label">Gender
                          </label>
                            <p className="control">
                              <input name="name" placeholder="Your gender ..." className="input" type="text"></input>
                            </p>
                          </div>
                          <div className="field"><label className="label bigger-font-label">Location
                          </label>
                            <p className="control">
                              <input name="name" placeholder="Your location ..." className="input" type="text"></input>
                            </p>
                          </div>
                          <div className="field">
